...
import com.cooder.cooder.project.app.databinding.ItemDetailCommentAreaBinding
import com.cooder.cooder.project.app.databinding.ItemDetailCommentBinding
import com.cooder.cooder.project.app.model.CommentModel
	...
	private fun bindCommentTags(context: Context, commentTags: String) {
		...
		commentTags.split(' ').forEachIndexed { index, tag ->
			val chipLabel = if (index < binding.chipGroup.childCount) {
				...
				chipLabel.chipBackgroundColor = ContextCompat.getColorStateList(context, R.color.detail_comment_container_label_bg)
